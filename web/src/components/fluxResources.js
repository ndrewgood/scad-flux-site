        ...
        <section className="fluxResources graySection">
            <div className="container">
                ...
                <div className="threeGrid">
                    ...
                    <ResourceCard title="QBits" description="QBits is a series of live workshops hosted by FLUX members Quint, Lara, and Zachra to help you learn softwares core to creating stunning UX projects!" cta="Watch Recordings" link="" image={Qbits}/>
                </div>
            </div>
        </section>
    )
